...
import { SearchCheck, FlaskConical, PackageCheck, RefreshCw } from "lucide-react";
...
const steps = [
  ...
  },
  {
    ...
    text: "Development and refinement of formulations through structured sampling.",
    icon: FlaskConical,
    image: "/hero-rice.jpg",
  },
  {
    ...
    text: "Finalisation of specifications, packaging, documentation, and timelines.",
    icon: PackageCheck,
    image: "/hero-rice.jpg",
  },
  {
...
export default function PrivateLabelTimeline() {
  ...
  useEffect(() => {
    ...
    const items = section.querySelectorAll(".private-timeline-item");
    const dots = section.querySelectorAll(".private-timeline-dot");
    const pulses = section.querySelectorAll(".private-timeline-pulse");
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="heading-section">Our Private Label Process</h2>
        </div>
          ...
          <div className="space-y-10 md:space-y-0">
            {steps.map((step, index) => {
              ...
              return (
                <div
                  key={step.title}
                  className={`private-timeline-item relative grid md:grid-cols-2 md:gap-16 items-center ${
                    !isLast ? "md:pb-16" : ""
                  }`}
                >
                  <div className="private-timeline-dot hidden md:flex absolute left-1/2 top-7 h-11 w-11 -translate-x-1/2 items-center justify-center rounded-full bg-[var(--page-bg)] border border-[var(--olive)] z-10">
                    <span className="private-timeline-pulse absolute h-11 w-11 rounded-full border border-[var(--olive)]" />
